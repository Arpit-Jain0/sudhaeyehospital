...
export const metadata: Metadata = {
  ...
  description: "Leading eye hospital providing comprehensive eye care services including cataract surgery, LASIK, retina treatment, and more. Book your appointment today.",
